...
import lk.ijse.exam.utilities.PanelLoginText;
...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void performLogin(){
        try {
            ...
            studentDTO.setName(txtUsername.getText());
            studentDTO.setPassword(txtPassword.getText());
            if (!txtUsername.getText().isEmpty() && !txtPassword.getText().isEmpty()) {
                int id = LoginFormController.chkLogin(studentDTO);
                if (id != 0) {
                    new StudentView(id);
                    this.dispose();
                } else {
